...
export function EmpleadosTable() {
  ...
  return (
    <div className="mt-12 mb-8 flex flex-col gap-12 h-screen overflow-hidden">
      <div className="flex-1 overflow-y-auto">
        <Card className="sticky-top-header">
          ...
          <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
            <div className="sticky-search-bar flex flex-col md:flex-row items-center justify-between gap-4 px-4 mb-4 py-3">
